...
A Plus fork of CLIProxyAPI that tracks upstream while preserving additional third-party provider support.

It provides OpenAI/Gemini/Claude/Codex compatible API interfaces for CLI.
