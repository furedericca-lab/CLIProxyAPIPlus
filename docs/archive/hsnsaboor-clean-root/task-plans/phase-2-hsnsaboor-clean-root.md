---
description: Phase 2 task plan for applying local docs and wiki policy on top of HsnSaboor.
---
...
- Scope execution docs live under `docs/archive/hsnsaboor-clean-root/`.
...
Definition of Done: wiki is tracked and valid, scope docs are under `docs/archive/hsnsaboor-clean-root/`, and old `docs/*` content is not restored.

Tasks:

- [x] T005 [Config] Update `.gitignore` for tracked wiki and current scope docs
  - DoD: `.codex/wiki/index.md` and `docs/archive/hsnsaboor-clean-root/hsnsaboor-clean-root-contract.md` are not ignored; `.codex/notepad.md` remains ignored.
...
- [x] T007 [Docs] Add current scope docs under `docs/archive/hsnsaboor-clean-root/`
  - DoD: contract, phase checklist, and phase files exist under `docs/archive/hsnsaboor-clean-root/`.
